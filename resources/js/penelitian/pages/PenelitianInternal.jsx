...
const PenelitianInternal = () => {
    const { language } = useLanguage();

    // Dummy Data for Internal Research
    const researches = [
        {
            id: 1,
            title: "Analisis Potensi Wisata Religi di Kabupaten Pamekasan Berbasis Kearifan Lokal",
            researcher: "Drs. H. Moh. Zahid, M.Pd.",
            members: "Siti Aminah, S.Pd.I., M.Pd.I",
            year: "2025",
            scheme: "Hibah Penelitian Dosen Tetap",
            status: "On Going"
        },
        {
            id: 2,
            title: "Pengaruh Penggunaan Gadget Terhadap Perkembangan Sosial Emosional Anak Usia Dini di Pamekasan",
            researcher: "Dewi Kartika, S.Psi., M.Si.",
            members: "-",
            year: "2024",
            scheme: "Hibah Kompetitif Kampus",
            status: "Finished"
        },
        {
            id: 3,
            title: "Rancang Bangun Sistem Informasi Manajemen Aset Desa Berbasis Web (Studi Kasus: Desa Larangan)",
            researcher: "Fajar Siddiq, S.Kom., M.T.",
            members: "Rina Wati, S.Kom.",
            year: "2024",
            scheme: "Hibah Penelitian Pemula",
            status: "Finished"
        },
        {
            id: 4,
            title: "Kajian Hukum Islam Terhadap Praktik Jual Beli Online dengan Sistem Dropship",
            researcher: "Dr. H. Abdul Malik, M.Ag.",
            ...
            <div style={{
                ...
                >
                    <h1 style={{ fontSize: '2.5rem', fontWeight: 'bold', marginBottom: '15px', letterSpacing: '1px' }}>
                        {language === 'id' ? 'Penelitian Internal' : 'Internal Research'}
                    </h1>
                    <p style={{ fontSize: '1.1rem', opacity: 0.9, maxWidth: '800px', margin: '0 auto' }}>
                        {language === 'id'
                            ? "Daftar penelitian yang didanai melalui skema Hibah Internal Universitas Islam Madura untuk mendorong produktivitas dosen."
                            : "List of research funded through the Islamic University of Madura Internal Grant scheme to encourage lecturer productivity."}
                    </p>
                </motion.div>
            </div>
            ...
            <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
                ...
                <div style={{ display: 'flex', gap: '20px', marginBottom: '30px', flexWrap: 'wrap' }}>
                    <div style={{ backgroundColor: 'white', padding: '15px 25px', borderRadius: '10px', boxShadow: '0 5px 15px rgba(0,0,0,0.05)', flex: 1, borderLeft: '5px solid #004d26' }}>
                        ...
                        <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#333' }}>86</div>
                    </div>
                    <div style={{ backgroundColor: 'white', padding: '15px 25px', borderRadius: '10px', boxShadow: '0 5px 15px rgba(0,0,0,0.05)', flex: 1, borderLeft: '5px solid #f9a825' }}>
                        ...
                        <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#333' }}>32</div>
                    </div>
                ...
                <div style={{ marginBottom: '30px' }}>
                    <input
                        type="text"
                        placeholder={language === 'id' ? "Cari judul penelitian internal..." : "Search internal research title..."}
                        style={{
                            width: '100%',
                            padding: '15px',
                            borderRadius: '10px',
