    ...
    return (
        <div className="main-content" style={{ backgroundColor: '#f9f9f9', paddingBottom: '60px' }}>
            ...
            <div style={{
                ...
                >
                    <h1 style={{ fontSize: '3rem', fontWeight: 'bold', marginBottom: '15px', letterSpacing: '1px' }}>PROFIL LPPM</h1>
                    <p style={{ fontSize: '1.2rem', opacity: 0.9, maxWidth: '700px', margin: '0 auto' }}>
                        Lembaga Penelitian dan Pengabdian kepada Masyarakat (LPPM) Universitas Islam Madura
                    </p>
                </motion.div>
            </div>
            ...
            <div className="container" style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 20px' }}>
                ...
                >
                    <h2 style={{ color: '#333', marginBottom: '20px', fontWeight: 'bold' }}>Tentang Kami</h2>
                    <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#555', textAlign: 'justify' }}>
                        Lembaga Penelitian dan Pengabdian Masyarakat (LPPM) Universitas Islam Madura (UIM)
                        berkomitmen untuk meningkatkan kualitas penelitian dan pengabdian kepada masyarakat
                        melalui kolaborasi lintas disiplin ilmu. Kami hadir sebagai wadah inovasi yang menjembatani
                        akademisi dan kebutuhan masyarakat.
                    </p>
                </motion.div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', marginBottom: '40px' }}>
                    ...
                    >
                        ...
                        <h3 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '15px', color: '#004d26' }}>VISI</h3>
                        <p style={{ color: '#666', lineHeight: '1.6' }}>
                            "Menjadi lembaga riset unggulan yang mendukung pengembangan ilmu pengetahuan dan teknologi."
                        </p>
                    </motion.div>
                    ...
                    >
                        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px', gap: '15px' }}>
                            ...
                            <h3 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#004d26', margin: 0 }}>MISI</h3>
                        </div>
                ...
                >
                    <div style={{ textAlign: 'center', marginBottom: '30px' }}>
                        <h2 style={{ fontWeight: 'bold', fontSize: '2rem', marginBottom: '10px' }}>STRUKTUR ORGANISASI</h2>
                        <p style={{ opacity: 0.8 }}>Pilar pendukung keberhasilan program LPPM UIM</p>
                    </div>
                        ...
                        <div style={{ backgroundColor: 'rgba(255,255,255,0.1)', padding: '25px', borderRadius: '15px', backdropFilter: 'blur(5px)' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '15px' }}>
                                ...
                                <div>
                                    ...
                                    <div style={{ fontSize: '0.9rem', opacity: 0.8 }}>Kepala LPPM</div>
                                </div>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <div>
                                    ...
                                    <div style={{ fontSize: '0.9rem', opacity: 0.8 }}>Wakil Kepala</div>
                                </div>
                            </div>
                        </div>
